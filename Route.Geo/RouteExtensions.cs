...
namespace Route.Geo
{
    ...
    public static class RouteExtensions
    {
        ...
        /// </summary>
        public static Envelope GetBox(this global::Route.Route route)
        {
        ...
        /// </summary>
        public static LineString ToLineString(this global::Route.Route route)
        {
            if (route == null) { throw new ArgumentNullException("route"); }
            if (route.Shape == null)
            {
        ...
        /// </summary>
        public static FeatureCollection ToFeatureCollection(this global::Route.Route route)
        {
            ...
            { // one linestring per meta-object.
                ...
                for (var i = 1; i < route.ShapeMeta.Length; i++)
                {
                    ...
                    {
                        Logger.Log("RouteExtensions", TraceEventType.Warning, 
