...
namespace Route.Geo
{
    ...
    public static class RouterDbExtensions
    {
        ...
        /// </summary>
        public static FeatureCollection GetFeaturesIn(this RouterDb db, Coordinate coord1,
            Coordinate coord2, bool includeEdges = true, bool includeVertices = true)
        {
        ...
        public static Feature GetFeatureForEdge(this RouterDb routerDb, long edgeId)
        {
            ...
            var edgeAttributes = new AttributeCollection(routerDb.EdgeMeta.Get(edge.Data.MetaId));
