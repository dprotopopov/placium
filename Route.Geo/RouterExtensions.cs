...
namespace Route.Geo
{
    ...
    public static class RouterExtensions
    {
        ...
        /// </summary>
        public static global::Route.Route Calculate(this Router router, Profile profile, Coordinate source, Coordinate target)
        {
        ...
        /// </summary>
        public static global::Route.Route Calculate(this Router router, Profile profile, Coordinate[] locations)
        {
        ...
        /// Calculates a route between the two locations.
        /// </summary>
        public static Result<global::Route.Route> TryCalculate(this Router router, Profile profile, Coordinate source,
            Coordinate target)
        {
        ...
        /// Calculates a route along the given locations.
        /// </summary>
        public static Result<global::Route.Route> TryCalculate(this Router router, Profile profile, Coordinate[] locations)
        {
            ...
            for (var i = 2; i < resolved.Length; i++)
            {
                ...
                route = new Result<global::Route.Route>(route.Value.Concatenate(nextRoute.Value));
            }
            return route;
        }
