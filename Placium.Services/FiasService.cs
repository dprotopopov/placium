...
public class FiasService : BaseApiService
{
    ...
    private readonly List<string> _listAddrob = new();
    private readonly List<string> _listHouse = new();
    private readonly List<string> _listRoom = new();
    private readonly List<string> _listStead = new();
