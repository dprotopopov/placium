...
using Route.Profiles.Lua.Interop.ProxyObjects;
using Route.Profiles.Lua.Interop.RegistrationPolicies;
using Route.Profiles.Lua.Interop.StandardDescriptors;

namespace Route.Profiles.Lua.Interop.UserDataRegistries
{
	/// <summary>
