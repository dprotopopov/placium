...
namespace Route.IO.Osm.Normalizer
{
    /// <summary>
    ...
    public static class AttributeCollectionExtensions
    {
        ...
        {
            bool? access = global::Route.Osm.Vehicles.Vehicle.InterpretAccessValue(tags, "access");
            for (var i = 0; i < accessTags.Length; i++)
            {
                var currentAccess = global::Route.Osm.Vehicles.Vehicle.InterpretAccessValue(tags, accessTags[i]);
