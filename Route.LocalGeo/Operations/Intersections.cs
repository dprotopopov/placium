...
namespace Route.LocalGeo.Operations
{
    ...
    internal static class Intersections
    {
            ...
            float latitude2, float longitude2)
        {
            ...
            foreach (var intersection in intersections) sortedList.Add(intersection.Key, intersection.Value);
            ...
            Line line)
        {
            ...
            if (projected != null)
            {
                ...
                if (dist < E / 2) intersections.Add(new KeyValuePair<float, Coordinate>(0, projected.Value));
            }
