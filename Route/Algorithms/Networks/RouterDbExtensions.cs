...
using Route.Algorithms.Networks.Preprocessing;
using Route.Data.Network.Edges;
using Route.Profiles;

namespace Route.Algorithms.Networks
{
    /// <summary>
    ...
    public static class RouterDbExtensions
    {
        ...
        public static void OptimizeNetwork(this RouterDb routerDb, float simplifyEpsilonInMeter, CancellationToken cancellationToken)
        {
            ...
            var algorithm = new NetworkOptimizer(
                routerDb.Network, routerDb.GetHasAnyRestriction(), (EdgeData edgeData1, bool inverted1,
