...
namespace Route.Algorithms.Contracted
{
        ...
        where T : struct
    {
        ...
        /// </summary>
        public DirectedGraphBuilder(Graph source, DirectedMetaGraph target, WeightHandler<T> weightHandler)
        {
    ...
    public sealed class DirectedGraphBuilder : DirectedGraphBuilder<float>
    {
        ...
        /// Creates a new graph builder.
        /// </summary>
        public DirectedGraphBuilder(Graph source, DirectedMetaGraph target, DefaultWeightHandler weightHandler)
