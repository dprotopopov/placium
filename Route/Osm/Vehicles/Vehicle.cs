...
namespace Route.Osm.Vehicles
{
    ...
    public static class Vehicle
    {
        ...
        /// Default Car
        /// </summary>
        public static readonly Profiles.Vehicle Car = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.car.lua"));

        /// <summary>
        /// Default Pedestrian
        /// </summary>
        public static readonly Profiles.Vehicle Pedestrian = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.pedestrian.lua"));

        /// <summary>
        /// Default Bicycle
        /// </summary>
        public static readonly Profiles.Vehicle Bicycle = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.bicycle.lua"));

        /// <summary>
        /// Default Moped
        /// </summary>
        public static readonly Profiles.Vehicle Moped = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.moped.lua"));

        /// <summary>
        /// Default MotorCycle
        /// </summary>
        public static readonly Profiles.Vehicle MotorCycle = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.motorcycle.lua"));

        /// <summary>
        /// Default SmallTruck
        /// </summary>
        public static readonly Profiles.Vehicle SmallTruck = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.smalltruck.lua"));

        /// <summary>
        /// Default BigTruck
        /// </summary>
        public static readonly Profiles.Vehicle BigTruck = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.bigtruck.lua"));

        /// <summary>
        /// Default BigTruck
        /// </summary>
        public static readonly Profiles.Vehicle Bus = new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Route.Osm.Vehicles.bus.lua"));
