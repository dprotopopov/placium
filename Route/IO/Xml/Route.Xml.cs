...
//                    XmlExtensions.WriteAttribute(writer, (string) "lat", (float?) this.Shape[i].Latitude);
//                    XmlExtensions.WriteAttribute(writer, (string) "lon", (float?) this.Shape[i].Longitude);
...
//                    writer.WriteAttributeString("shape", Extensions.ToInvariantString((object) meta.Shape));
...
//                    writer.WriteAttributeString("shape", Extensions.ToInvariantString((object) branch.Shape));
...
//                    writer.WriteAttributeString("shape", Extensions.ToInvariantString((object) stop.Shape));
//                    XmlExtensions.WriteAttribute(writer, (string) "lat", (float?) stop.Coordinate.Latitude);
//                    XmlExtensions.WriteAttribute(writer, (string) "lon", (float?) stop.Coordinate.Longitude);
