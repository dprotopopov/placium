...
namespace Placium.Route.Osm.Vehicles
{
    ...
    public static class Vehicle
    {
        ...
        public static readonly Profiles.Vehicle Car =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.car.lua"));

        /// <summary>
        ///     Default Pedestrian
        /// </summary>
        public static readonly Profiles.Vehicle Pedestrian =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.pedestrian.lua"));

        /// <summary>
        ///     Default Bicycle
        /// </summary>
        public static readonly Profiles.Vehicle Bicycle =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.bicycle.lua"));

        /// <summary>
        ///     Default Moped
        /// </summary>
        public static readonly Profiles.Vehicle Moped =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.moped.lua"));

        /// <summary>
        ///     Default MotorCycle
        /// </summary>
        public static readonly Profiles.Vehicle MotorCycle =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.motorcycle.lua"));

        /// <summary>
        ///     Default SmallTruck
        /// </summary>
        public static readonly Profiles.Vehicle SmallTruck =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.smalltruck.lua"));

        /// <summary>
        ///     Default BigTruck
        /// </summary>
        public static readonly Profiles.Vehicle BigTruck =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.bigtruck.lua"));

        /// <summary>
        ///     Default BigTruck
        /// </summary>
        public static readonly Profiles.Vehicle Bus =
            new DynamicVehicle(VehicleExtensions.LoadEmbeddedResource("Placium.Route.Osm.Vehicles.bus.lua"));
        ...
        public static bool? InterpretAccessValue(IAttributeCollection attributes, string key)
        {
            ...
            {
                bool? value;
                if (GetAccessValues().TryGetValue(accessValue, out value)) return value;
            }
        ...
        /// </summary>
        public static bool InterpretAccessValues(IAttributeCollection attributes, Whitelist whiteList,
            IEnumerable<string> keys, params string[] rootKeys)
        {
            bool? value = null;
            var usedKey = string.Empty;
            for (var i = 0; i < rootKeys.Length; i++)
            {
                var currentAccess = InterpretAccessValue(attributes, rootKeys[i]);
            ...
            {
                var currentAccess = InterpretAccessValue(attributes, key);
                if (currentAccess != null)
                {
                    value = currentAccess;
                    usedKey = key;
            ...
            if (!string.IsNullOrWhiteSpace(usedKey)) whiteList.Add(usedKey);
