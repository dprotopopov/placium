...
public class Car
{
    private readonly Dictionary<string, bool> _accessValues = new()
    {
        { "private", false },
        { "yes", true },
        { "no", false },
    ...
    private readonly Dictionary<string, bool> _barriers = new()
    {
        { "gate", true },
        { "bollard", true },
        { "fence", true }
    ...
    private readonly Dictionary<string, float> _classificationsFactors = new()
    {
        { "motorway", 10f },
        { "motorway_link", 10f },
        { "trunk", 9f },
    ...
    private readonly List<string> _constraints = new() { "maxweight", "maxwidth" };

    private readonly float _maxSpeed = 200f;

    private readonly float _minSpeed = 30f;

    private readonly Dictionary<string, float> _speedProfile = new()
    {
        { "motorway", 120f },
        { "motorway_link", 120f },
        { "trunk", 90f },
